...
const gradient = require("gradient-string"); // 🔥 para el texto de colores
...
// 🌙✨ Banner de inicio estilo Michi Wa Bot
const banner = `
███╗   ██╗██╗██╗  ██╗██╗██╗     ██╗ ██████╗ ██╗  ██╗
████╗  ██║██║██║ ██╔╝██║██║     ██║██╔═══██╗██║ ██╔╝
██╔██╗ ██║██║█████╔╝ ██║██║     ██║██║   ██║█████╔╝ 
...
console.clear();
console.log(gradient("#7F00FF", "#E100FF")(banner)); // 💜 Degradado violeta/rosa
console.log(gradient.pastel("🌙  Iniciando Starlights Bot..."));
console.log(chalk.cyanBright("    made by Chinita 💫\n"));
...
async function startBot() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "open") {
      log.success("🌙 Conexión exitosa a WhatsApp — Starlights Bot listo 💫");
    }
  });
